...
uses
  ...
  JsonUtils in '..\ApiEmissorNFe\JsonUtils.pas',
  smNfe in '..\ApiEmissorNFe\smNfe.pas',
  uEmiteNfe in '..\ApiEmissorNFe\uEmiteNfe.pas';
...
exports
  GModuleData name 'nfe_emissor_module';
